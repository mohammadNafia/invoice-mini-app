                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="w-full flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                            <button onClick={handleLogin} className="bg-[#0F766E] text-white rounded-full py-2 px-4 font-semibold whitespace-nowrap">
                                Login
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-center">
                            <div className="xl:col-span-5 lg:col-span-6">
                                <div className="flex items-center text-sm font-medium text-[#334155] justify-center lg:justify-start">
                                    <span className="bg-[#5EEAD4] py-4 px-6 rounded-2xl text-xs  font-medium text-[#334155] mr-3">#1</span>
                                    invoice app
                                </div>

                                <h1 className="py-8 text-center text-[#0F172A] font-bold text-5xl lg:text-left leading-[70px]">
                                    Get paid with a better <span className="text-[#0F766E]">invoice flow</span>
                                </h1>

                                <p className="text-[#334155] text-lg text-center lg:text-left">
                                    Draft an invoice, choose the payer, scan, and pay all in one mini app
                                </p>
                                ...
                                <div className="relative p-1.5 my-10 flex items-center gap-y-4 h-auto md:h-16 flex-col md:flex-row justify-between rounded-full border border-transparent md:bg-white transition-all duration-500 hover:border-[#7DD3FC]">
                                    ...
                                    />
                                    <button onClick={handleLogin}className="bg-[#5EEAD4] rounded-full py-3 px-7 text-base font-semibold text-[#334155] md:w-fit w-full">
                                        Get started
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center flex-col lg:flex-row">
                                    <div className="flex items-center -space-x-3">
                                        <img src="https://pagedone.io/asset/uploads/1694846673.png" alt="Rounded" className="border-2 border-solid border-[#E2E8F0] rounded-full w-12 h-12 object-cover" />
                                        <img src="https://pagedone.io/asset/uploads/1694846691.png" alt="Rounded" className="border-2 border-solid border-[#E2E8F0] rounded-full w-12 h-12 object-cover" />
                                        <img src="https://pagedone.io/asset/uploads/1694846704.png" alt="Rounded" className="border-2 border-solid border-[#E2E8F0] rounded-full w-12 h-12 object-cover" />
                                    </div>
                                    <span className="mt-3 text-base text-[#334155] font-medium lg:ml-3">People have joined</span>
                                </div>
                            </div>

                            <div className="xl:col-span-7 lg:col-span-6">
                                <img src="/Screenshot 2025-12-31 185024.png" alt="Dashboard" className="rounded-l-3xl object-cover w-full lg:h-auto" />
                            </div>
                        </div>
                    </div>
                </div>
